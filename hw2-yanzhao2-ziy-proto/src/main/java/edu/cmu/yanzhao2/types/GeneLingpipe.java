...
public class GeneLingpipe extends Annotation {
  ...
  */  
   ...
   */
  public String getId() {
    if (GeneLingpipe_Type.featOkTst && ((GeneLingpipe_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "edu.cmu.yanzhao2.types.GeneLingpipe");
    return jcasType.ll_cas.ll_getStringValue(addr, ((GeneLingpipe_Type)jcasType).casFeatCode_id);}
  ...
  public void setId(String v) {
    if (GeneLingpipe_Type.featOkTst && ((GeneLingpipe_Type)jcasType).casFeat_id == null)
      jcasType.jcas.throwFeatMissing("id", "edu.cmu.yanzhao2.types.GeneLingpipe");
    jcasType.ll_cas.ll_setStringValue(addr, ((GeneLingpipe_Type)jcasType).casFeatCode_id, v);}    
  ...
  public String getContent() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr, ((GeneLingpipe_Type)jcasType).casFeatCode_content);}
