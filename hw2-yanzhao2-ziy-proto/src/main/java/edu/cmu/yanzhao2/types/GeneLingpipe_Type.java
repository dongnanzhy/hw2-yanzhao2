...
public class GeneLingpipe_Type extends Annotation_Type {
  ...
  /**  
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.yanzhao2.types.GeneLingpipe");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.cmu.yanzhao2.types.GeneLingpipe");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "edu.cmu.yanzhao2.types.GeneLingpipe");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "edu.cmu.yanzhao2.types.GeneLingpipe");
